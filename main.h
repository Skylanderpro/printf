...
void print_binary(unsigned int num, char *buffer, int *count,
		int *buffer_index);
void print_unsigned_int(unsigned int, char *buffer, int *count,
		int *buffer_index);
void print_octal(unsigned int, char *buffer, int *count, int *buffer_index);
void print_hexad_lower(unsigned int, char *buffer, int *count,
		int *buffer_index);
void print_hexad_upper(unsigned int, char *buffer, int *count,
		int *buffer_index);
